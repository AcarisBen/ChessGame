...
public class ChessMatch { // Regras do jogo
	...
	private void initialSetup() { //Assim que iniciará no tabuleiro
		placeNewPiece('b', 6, new Rook(board, Color.WHITE)); // Coloca a torre branca na posição
		placeNewPiece('e', 8, new King(board, Color.BLACK)); // Coloca a rei preto na posição
		placeNewPiece('e', 1,new King(board, Color.WHITE)); // Coloca o rei branco na posição
	}
}
